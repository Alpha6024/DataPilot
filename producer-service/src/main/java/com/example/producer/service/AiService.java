...
public class AiService {
    ...
    public String ask(String question, List<String> context) {
        ...
        String prompt = String.format("""
                ...
                3. If the question requires calculations, calculate using ONLY the retrieved context.
                ...
                6. If the answer is not present in the context, reply exactly: "I cant't find releted data in document."
                7. Keep the answer clear, concise, and well formatted.
                8. Do not use markdown, asterisks, hashtags, or any special formatting. Plain text only.
